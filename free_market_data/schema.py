...
DEFAULT_FIELD_DESCRIPTIONS = [
    ...
    {"field": "volume_post", "table": "daily", "dtype": "float64", "description": "盘后成交量，来自支持该字段的数据源直接返回", "source": "system"},
    {"field": "amount_post", "table": "daily", "dtype": "float64", "description": "盘后成交额，来自支持该字段的数据源直接返回", "source": "system"},
    {"field": "amplitude", "table": "daily", "dtype": "float64", "description": "振幅，通常为百分比数值，来自支持该字段的数据源直接返回", "source": "system"},
    {"field": "pct_change", "table": "daily", "dtype": "float64", "description": "涨跌幅，通常为百分比数值，来自支持该字段的数据源直接返回", "source": "system"},
    {"field": "change", "table": "daily", "dtype": "float64", "description": "涨跌额，来自支持该字段的数据源直接返回", "source": "system"},
    ...
    {"field": "pcf_ttm", "table": "daily", "dtype": "float64", "description": "滚动市现率", "source": "system"},
    {"field": "trade_status", "table": "daily", "dtype": "float64", "description": "交易状态，通常 1 表示正常交易，0 表示停牌或无交易", "source": "system"},
    {"field": "is_st", "table": "daily", "dtype": "float64", "description": "是否 ST，通常 1 表示 ST，0 表示非 ST", "source": "system"},
    {"field": "total_market_cap", "table": "daily", "dtype": "float64", "description": "总市值，来自支持该字段的数据源直接返回", "source": "system"},
